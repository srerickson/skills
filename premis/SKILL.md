...
|------|-----------|------------|
| `references/premis-hierarchical-3-0.md` | Complete outline of every semantic unit with number, mandatory/optional, repeatable/not, and applicable object categories | Fast lookup of structure, obligation, repeatability |
| `references/premis-3-0-datadictionary-only.pdf` | Full Data Dictionary (226 pp.) — the normative definition of every semantic unit | Definitions, rationale, data constraints, creation/maintenance notes, usage examples |
| `references/premis-v3-0.xsd` | Official XML schema, namespace `http://www.loc.gov/premis/v3` | XML serialization details, element order, attributes |
...
```bash
pdftotext references/premis-3-0-datadictionary-only.pdf /tmp/dd.txt
...
- Validate exports:
  `xmllint --noout --schema references/premis-v3-0.xsd instance.xml`
